...
${OBJECTDIR}/src/CabalarUtils.o: src/CabalarUtils.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/CabalarUtils.o src/CabalarUtils.cpp
...
${TESTDIR}/src/tests/TestHelloWorld.o: src/tests/TestHelloWorld.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/src/tests/TestHelloWorld.o src/tests/TestHelloWorld.cpp


${TESTDIR}/src/tests/TestHelloWorldRunner.o: src/tests/TestHelloWorldRunner.cpp 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/src/tests/TestHelloWorldRunner.o src/tests/TestHelloWorldRunner.cpp
...
${OBJECTDIR}/src/Cabalar_nomain.o: ${OBJECTDIR}/src/Cabalar.o src/Cabalar.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Cabalar_nomain.o src/Cabalar.cpp;\
	else  \
...
${OBJECTDIR}/src/CabalarUtils_nomain.o: ${OBJECTDIR}/src/CabalarUtils.o src/CabalarUtils.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/CabalarUtils_nomain.o src/CabalarUtils.cpp;\
	else  \
...
${OBJECTDIR}/src/Formula_nomain.o: ${OBJECTDIR}/src/Formula.o src/Formula.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Formula_nomain.o src/Formula.cpp;\
	else  \
...
${OBJECTDIR}/src/Formulas_nomain.o: ${OBJECTDIR}/src/Formulas.o src/Formulas.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Formulas_nomain.o src/Formulas.cpp;\
	else  \
...
${OBJECTDIR}/src/HengZhang_nomain.o: ${OBJECTDIR}/src/HengZhang.o src/HengZhang.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/HengZhang_nomain.o src/HengZhang.cpp;\
	else  \
...
${OBJECTDIR}/src/NNFUtils_nomain.o: ${OBJECTDIR}/src/NNFUtils.o src/NNFUtils.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/NNFUtils_nomain.o src/NNFUtils.cpp;\
	else  \
...
${OBJECTDIR}/src/Rule_nomain.o: ${OBJECTDIR}/src/Rule.o src/Rule.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Rule_nomain.o src/Rule.cpp;\
	else  \
...
${OBJECTDIR}/src/S2DLP_nomain.o: ${OBJECTDIR}/src/S2DLP.o src/S2DLP.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/S2DLP_nomain.o src/S2DLP.cpp;\
	else  \
...
${OBJECTDIR}/src/Vocabulary_nomain.o: ${OBJECTDIR}/src/Vocabulary.o src/Vocabulary.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Vocabulary_nomain.o src/Vocabulary.cpp;\
	else  \
...
${OBJECTDIR}/src/lex_nomain.o: ${OBJECTDIR}/src/lex.o src/lex.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/lex_nomain.o src/lex.cpp;\
	else  \
...
${OBJECTDIR}/src/parse_nomain.o: ${OBJECTDIR}/src/parse.o src/parse.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/parse_nomain.o src/parse.cpp;\
	else  \
