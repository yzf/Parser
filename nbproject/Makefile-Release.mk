...
${OBJECTDIR}/src/CircTranslator.o: src/CircTranslator.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/CircTranslator.o src/CircTranslator.cpp
...
${OBJECTDIR}/src/Optimization.o: src/Optimization.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Optimization.o src/Optimization.cpp
...
${OBJECTDIR}/src/SMTranslator.o: src/SMTranslator.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/SMTranslator.o src/SMTranslator.cpp
...
${OBJECTDIR}/src/CircTranslator_nomain.o: ${OBJECTDIR}/src/CircTranslator.o src/CircTranslator.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/CircTranslator_nomain.o src/CircTranslator.cpp;\
	else  \
...
${OBJECTDIR}/src/Optimization_nomain.o: ${OBJECTDIR}/src/Optimization.o src/Optimization.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Optimization_nomain.o src/Optimization.cpp;\
	else  \
...
${OBJECTDIR}/src/SMTranslator_nomain.o: ${OBJECTDIR}/src/SMTranslator.o src/SMTranslator.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 `cppunit-config --cflags` -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/SMTranslator_nomain.o src/SMTranslator.cpp;\
	else  \
